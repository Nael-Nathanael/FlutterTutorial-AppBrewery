...
class QuizBrain {
	...
	List<Question> _questions = [
		...
		Question(
			...
			false),
		Question(
			'The total surface area of two human lungs is approximately '
				'70 square metres.',
			true),
		...
		Question(
			'In West Virginia, USA, '
				'if you accidentally hit an animal with your car, '
				'you are free to take it home to eat.',
			true),
	];

	void nextQuestion() {
		if (_questionNumber < _getTotalQuestion() - 1) {
			_questionNumber++;
		}
	}
	...
	bool answerNow(bool submittedAnswer) {
		return _getQuestionAnswer() == submittedAnswer;
	}
